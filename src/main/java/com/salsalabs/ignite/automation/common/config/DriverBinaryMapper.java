...
import static com.salsalabs.ignite.automation.common.config.DriverBinaryContext.binaryFor;
import static com.salsalabs.ignite.automation.common.config.DriverBinaryContext.binaryPath;
import static com.salsalabs.ignite.automation.common.config.DriverType.*;
import static com.salsalabs.ignite.automation.common.config.OperatingSystem.*;
import static com.salsalabs.ignite.automation.common.config.SystemArchitecture.ARCHITECTURE_32_BIT;
import static com.salsalabs.ignite.automation.common.config.SystemArchitecture.ARCHITECTURE_64_BIT;
    ...
    static void configureBinary(DriverType driverType, OperatingSystem operatingSystem, SystemArchitecture systemArchitecture) {
        if (!useRemoteWebDriver) {
            ...
            if (null != binarySystemProperty && binarySystemProperty.length() != 0) {
                ...
                SeleneseTestCase.logger.info("Setting System Property '" + binarySystemProperty + "'='" + binaryConfiguration + "'");
