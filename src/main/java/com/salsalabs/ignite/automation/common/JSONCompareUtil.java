...
public class JSONCompareUtil {
    ...
    public static void jsonXAssertEqualsIgnoreNodes(String message, String actualJSON, String expectedJSON, String[] ignoreNodes, JSONCompareMode strict) throws JSONException{
        if(!expectedJSON.equalsIgnoreCase("")) {
    ...
    public static void jsonXAssertEqualsIgnoreValues(String message, String actualJSON, String expectedJSON, String[] ignoreValueForNodes, JSONCompareMode strict) throws JSONException{
    ...
    public static void jsonXAssertEqualsPartial(String message, String actualJSON, String expectedJSON, String[] ignoreNodes, String[] ignoreValueForNodes, JSONCompareMode strict) throws JSONException{
        if(!expectedJSON.equalsIgnoreCase("")) {
            actualJSON = removeIgnoredNodes(actualJSON, ignoreNodes);
            expectedJSON = removeIgnoredNodes(expectedJSON, ignoreNodes);
