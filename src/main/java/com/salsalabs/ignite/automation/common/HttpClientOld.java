...
public class HttpClientOld {
	...
	public HttpClientOld(String host) throws NoSuchAlgorithmException, KeyStoreException, KeyManagementException {
	  	this.host = host.replace("https://", "");
	  	//getConnection();
	}
	
	public HttpClientOld() throws NoSuchAlgorithmException, KeyStoreException, KeyManagementException {
	  	this.host = SeleneseTestCase.USED_ENVIRONMENT.getBaseTestUrl().replace("https://", "");
	  	//getConnection();
	}
	
	public HttpClientOld login(String userName, String pass) throws URISyntaxException, ClientProtocolException, IOException {
		updateHeaders();
	...
	public HttpClientOld createCustomField(JSONObject customField){
		try {
