...
public class ImportDonationResponse extends ExpectedResult {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ImportDonationResponse) == false) {
            return false;
        }
        ImportDonationResponse rhs = ((ImportDonationResponse) other);
