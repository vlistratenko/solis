...
public class GetActivityByTypeTicketedEventResponse extends ExpectedResult {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetActivityByTypeTicketedEventResponse)) return false;

        GetActivityByTypeTicketedEventResponse that = (GetActivityByTypeTicketedEventResponse) o;
    ...
    public String toString() {
        return "GetActivityByTypeTicketedEventResponse{" +
                "id='" + id + '\'' +
                ", timestamp='" + timestamp + '\'' +
                ", header=" + header +
                ", payload=" + payload +
