...
@JsonPropertyOrder({ "id", "firstName", "middleName", "lastName", "email", "homePhone", "workPhone", "city",
		"addressLine1", "addressLine2", "state", "stateCode", "zipCode", "country", "countryCode", "supporterId",
		"dateOfBirth", "gender", "suffix", "title", "referringUrl", "customFields", "activityType",
		"confirmationCheckbox", "keepInformed", "transactionType", "amount", "transactionDate", "onlineTransaction",
		"registrationAmount", "donationAmount", "ticketsPurchased", "anonymous", "designation", "dedicationType",
		"dedication", "coverFees", "notify" })
public class Result {
	...
	public String toString() {
		return "Result [id=" + id + ", firstName=" + firstName + ", middleName=" + middleName + ", lastName=" + lastName
				+ ", email=" + email + ", homePhone=" + homePhone + ", workPhone=" + workPhone + ", city=" + city
				+ ", addressLine1=" + addressLine1 + ", addressLine2=" + addressLine2 + ", state=" + state
				+ ", stateCode=" + stateCode + ", zipCode=" + zipCode + ", country=" + country + ", countryCode="
				+ countryCode + ", supporterId=" + supporterId + ", dateOfBirth=" + dateOfBirth + ", gender=" + gender
				+ ", suffix=" + suffix + ", title=" + title + ", referringUrl=" + referringUrl + ", customFields="
				+ customFields + ", activityType=" + activityType + ", confirmationCheckbox=" + confirmationCheckbox
				+ ", keepInformed=" + keepInformed + ", transactionType=" + transactionType + ", amount=" + amount
				+ ", transactionDate=" + transactionDate + ", onlineTransaction=" + onlineTransaction
				+ ", registrationAmount=" + registrationAmount + ", donationAmount=" + donationAmount
				+ ", ticketsPurchased=" + ticketsPurchased + ", anonymous=" + anonymous + ", designation=" + designation
				+ ", dedicationType=" + dedicationType + ", dedication=" + dedication + ", coverFees=" + coverFees
				+ ", notify=" + notify + ", additionalProperties=" + additionalProperties + "]";
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((ticketsPurchased == null) ? 0 : ticketsPurchased.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (ticketsPurchased == null) {
			if (other.ticketsPurchased != null)
				return false;
		} else if (!ticketsPurchased.equals(other.ticketsPurchased))
			return false;
		if (title == null) {
			if (other.title != null)
				return false;
