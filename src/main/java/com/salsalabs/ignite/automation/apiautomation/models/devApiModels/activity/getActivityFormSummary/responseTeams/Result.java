package com.salsalabs.ignite.automation.apiautomation.models.devApiModels.activity.getActivityFormSummary.responseTeams;
...
@JsonPropertyOrder({ "firstName", "middleName", "lastName", "email", "homePhone", "cellPhone", "workPhone", "city",
		...
		"dateOfBirth", "preferredLanguage", "suffix", "title", "referringUrl", "customFields", "teamPageName", "type",
		"enabled", "teamUrl", "goal", "totalDonationsAmount", "totalDonationsCount", "lastTransactionDate", "teamId",
		"teamMembersCount" })
public class Result {
	...
	public String toString() {
		return "Result [firstName=" + firstName + ", middleName=" + middleName + ", lastName=" + lastName + ", email="
				...
				+ ", referringUrl=" + referringUrl + ", customFields=" + customFields + ", teamPageName=" + teamPageName
				+ ", type=" + type + ", enabled=" + enabled + ", teamUrl=" + teamUrl + ", goal=" + goal
				+ ", totalDonationsAmount=" + totalDonationsAmount + ", totalDonationsCount=" + totalDonationsCount
				+ ", lastTransactionDate=" + lastTransactionDate + ", teamId=" + teamId + ", teamMembersCount="
				+ teamMembersCount + ", additionalProperties=" + additionalProperties + "]";
	}
