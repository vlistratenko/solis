...
public class AssignSupporterResponse extends ExpectedResult {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AssignSupporterResponse) == false) {
            return false;
        }
        AssignSupporterResponse rhs = ((AssignSupporterResponse) other);
