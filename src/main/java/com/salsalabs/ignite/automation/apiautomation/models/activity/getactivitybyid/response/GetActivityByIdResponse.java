...
public class GetActivityByIdResponse extends ExpectedResult {
    @SerializedName("id")
    @Expose
    private String id;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetActivityByIdResponse)) return false;

        GetActivityByIdResponse that = (GetActivityByIdResponse) o;
