package com.salsalabs.ignite.automation.apiautomation.models.devApiModels.activity.getActivityFormSummary.resposeGetTeamMetadataAndSummary;
...
@JsonPropertyOrder({ "firstName", "middleName", "lastName", "email", "homePhone", "cellPhone", "workPhone", "city",
		...
		"dateOfBirth", "preferredLanguage", "suffix", "title", "customFields", "teamPageName", "type", "enabled",
		"teamUrl", "totalDonationsAmount", "totalDonationsCount", "lastTransactionDate", "teamId", "teamMembersCount",
		"fundraiserId", "teamCaptainId", "teamCaptainName" })
public class Payload {
	...
	@JsonProperty("teamCaptainId")
	private String teamCaptainId;
	@JsonProperty("teamCaptainName")
	...
	@JsonProperty("teamPageName")
	public String getTeamPageName() {
		return teamPageName;
	}

	@JsonProperty("teamPageName")
	public void setTeamPageName(String teamPageName) {
		this.teamPageName = teamPageName;
	}
	...
	public String toString() {
		return "Payload [firstName=" + firstName + ", middleName=" + middleName + ", lastName=" + lastName + ", email="
				...
				+ ", customFields=" + customFields + ", teamPageName=" + teamPageName + ", type=" + type + ", enabled="
				+ enabled + ", teamUrl=" + teamUrl + ", totalDonationsAmount=" + totalDonationsAmount
				+ ", totalDonationsCount=" + totalDonationsCount + ", lastTransactionDate=" + lastTransactionDate
				+ ", teamId=" + teamId + ", teamMembersCount=" + teamMembersCount + ", fundraiserId=" + fundraiserId
				+ ", teamCaptainId=" + teamCaptainId + ", teamCaptainName=" + teamCaptainName
	...
	public int hashCode() {
		...
		result = prime * result + ((teamCaptainId == null) ? 0 : teamCaptainId.hashCode());
		result = prime * result + ((teamCaptainName == null) ? 0 : teamCaptainName.hashCode());
		result = prime * result + ((teamId == null) ? 0 : teamId.hashCode());
		result = prime * result + ((teamMembersCount == null) ? 0 : teamMembersCount.hashCode());
		result = prime * result + ((teamPageName == null) ? 0 : teamPageName.hashCode());
		result = prime * result + ((teamUrl == null) ? 0 : teamUrl.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (teamCaptainId == null) {
			if (other.teamCaptainId != null)
				return false;
		} else if (!teamCaptainId.equals(other.teamCaptainId))
			return false;
		if (teamCaptainName == null) {
			if (other.teamCaptainName != null)
				return false;
		} else if (!teamCaptainName.equals(other.teamCaptainName))
			return false;
		if (teamId == null) {
		...
		if (teamMembersCount == null) {
			if (other.teamMembersCount != null)
				return false;
		} else if (!teamMembersCount.equals(other.teamMembersCount))
			return false;
		if (teamPageName == null) {
			if (other.teamPageName != null)
				return false;
		} else if (!teamPageName.equals(other.teamPageName))
			return false;
		if (teamUrl == null) {
			if (other.teamUrl != null)
				return false;
		} else if (!teamUrl.equals(other.teamUrl))
			return false;
		if (title == null) {
			if (other.title != null)
				return false;
