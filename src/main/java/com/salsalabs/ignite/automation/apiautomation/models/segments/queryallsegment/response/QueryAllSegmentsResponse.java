...
public class QueryAllSegmentsResponse extends ExpectedResult {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof QueryAllSegmentsResponse) == false) {
            return false;
        }
        QueryAllSegmentsResponse rhs = ((QueryAllSegmentsResponse) other);
