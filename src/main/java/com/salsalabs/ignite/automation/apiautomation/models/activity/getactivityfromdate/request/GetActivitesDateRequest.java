...
public class GetActivitesDateRequest extends CommonRequest {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GetActivitesDateRequest) == false) {
            return false;
        }
        GetActivitesDateRequest rhs = ((GetActivitesDateRequest) other);
