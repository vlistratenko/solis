...
public class TicketedEventFormMetaData extends ExpectedResult{
    ...
    public boolean equals(Object o) {
        ...
        TicketedEventFormMetaData that = (TicketedEventFormMetaData) o;
    ...
    public String toString() {
        return "TicketedEventFormMetaData{" +
                "id='" + id + '\'' +
                ", payload=" + payload +
