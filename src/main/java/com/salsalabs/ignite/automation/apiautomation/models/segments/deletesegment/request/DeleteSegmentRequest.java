...
public class DeleteSegmentRequest extends CommonRequest {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DeleteSegmentRequest) == false) {
            return false;
        }
        DeleteSegmentRequest rhs = ((DeleteSegmentRequest) other);
