package com.salsalabs.ignite.automation.apiautomation.models.devApiModels.activity.getActivityFormSummary.responseFundraisers;
...
@JsonPropertyOrder({ "firstName", "middleName", "lastName", "email", "homePhone", "cellPhone", "workPhone", "city",
		...
		"dateOfBirth", "preferredLanguage", "suffix", "title", "referringUrl", "customFields", "fundraiserPageName",
		"type", "enabled", "fundraiserUrl", "goal", "totalDonationsAmount", "totalDonationsCount",
		"lastTransactionDate", "teamId", "fundraiserId" })
public class Result {
	...
	public String toString() {
		return "Result [firstName=" + firstName + ", middleName=" + middleName + ", lastName=" + lastName + ", email="
				...
				+ ", referringUrl=" + referringUrl + ", customFields=" + customFields + ", fundraiserPageName="
				+ fundraiserPageName + ", type=" + type + ", enabled=" + enabled + ", fundraiserUrl=" + fundraiserUrl
				+ ", goal=" + goal + ", totalDonationsAmount=" + totalDonationsAmount + ", totalDonationsCount="
				+ totalDonationsCount + ", lastTransactionDate=" + lastTransactionDate + ", teamId=" + teamId
				+ ", fundraiserId=" + fundraiserId + ", additionalProperties=" + additionalProperties + "]";
	}
