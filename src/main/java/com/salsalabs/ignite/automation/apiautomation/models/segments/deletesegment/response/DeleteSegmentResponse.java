...
public class DeleteSegmentResponse extends ExpectedResult {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DeleteSegmentResponse) == false) {
            return false;
        }
        DeleteSegmentResponse rhs = ((DeleteSegmentResponse) other);
