...
public class CreateSegmentRequest extends CommonRequest {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CreateSegmentRequest) == false) {
            return false;
        }
        CreateSegmentRequest rhs = ((CreateSegmentRequest) other);
