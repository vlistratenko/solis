...
public class GetTicketedEventFormMetadataTest extends CommonTest {
    ...
    public void getTestData() throws IOException {
        loadExpectedResultObj(
                ...
                {{
                    put(TEST_DATA_PATH_EVENT_FORm_SUMMARY_RESPONSE + "get_ticketed_event_form_metadata.json", TicketedEventFormMetaData.class);
    ...
    @Parameters({"ENV" , "UUID"})
    @Test(priority = 1)
    public void getTicketedEventFormMetadata(String env, String uuid) throws IOException {
        ResponseEntity<TicketedEventFormMetaData> response =
                restClient.exchange(env + Config.Endpoints.ACTIVITYCORESUMMARY + uuid + "/metadata", HttpMethod.GET, buildRequest(null), TicketedEventFormMetaData.class);
        TicketedEventFormMetaData expectedResultObj = ((TicketedEventFormMetaData) getExpectedResult("get_ticketed_event_form_metadata.json"));
