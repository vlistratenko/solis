...
/**
 * <b>This test contains scenarios related to custom fields creation (TestLink:
 * TC8)</b>
 * 
 * @author a.hubachov
 */
public class CreateCustomFieldTest extends SeleneseTestCase {
	 ...
	 * 
	 */
	@Test(enabled = true, groups = { "createAllCustomFields" }, dependsOnMethods = {
			"initAllCustomFieldsCreationTest" }, retryAnalyzer = RetryAnalyzer.class)
	...
	private CustomFieldsPage doLoginAndOpenCustomFieldPage() {
		return new LoginPage().doSuccessLogin().openSettingsPage().switchToCustomFieldsPage();
	}
}
