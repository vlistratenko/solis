...
import static com.salsalabs.ignite.automation.apiautomation.config.Config.TEST_DATA_PATH_TEAM_SUMMARY_RESPONSE;
...
public class Getp2pTeamSummaryTest  extends CommonTest{
	 ...
	 @BeforeTest
	    public void getTestData() throws IOException {
	        loadExpectedResultObj(
	                ...
	                {{
	                    put(TEST_DATA_PATH_TEAM_SUMMARY_RESPONSE + "get_p2p_team_summary_response.json", GetP2pTeamSummaryResponse.class);
	  ...
	  @Parameters({"ENV"})
	   ...
	   @Parameters({"ENV" , "UUID"})
	    ...
	    public void getP2pTeamSummary(String env, String uuid) throws IOException {
	        ResponseEntity<GetP2pTeamSummaryResponse> response =
	             restClient.exchange(env + Endpoints.ACTIVITYCORESUMMARY+ uuid+"/summary/teams", HttpMethod.GET, buildRequest(null), GetP2pTeamSummaryResponse.class);
	        GetP2pTeamSummaryResponse expectedResultObj = ((GetP2pTeamSummaryResponse) getExpectedResult("get_p2p_team_summary_response.json"));
	   ...
	   @Parameters({"ENV"})
	    ...
	    public void getMetricsAfterExecution(String env) throws IOException {
	        ...
	        metricsBeforeExecution.getPayload().setP2pTeamsList(metricsBeforeExecution.getPayload().getP2pTeamsList()+1);
