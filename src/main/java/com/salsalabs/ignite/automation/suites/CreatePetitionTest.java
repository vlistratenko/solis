...
/**
 * <b>This test contains scenarios related to petition creation (TestLink: TC28,
 * TC29)</b>
 */
public class CreatePetitionTest extends SeleneseTestCase {
	 ...
	 * <li><font color="green"><b>Verify that link of form is listed on the
	 * page</b></font>
	 * <li>Open Activities page --> All Activities
	 * <li><font color="green"><b>Verify that record about the widget is on the
	 * top of the table (All Activities) and status is PUBLISHED </b></font>
	 * <li>Open Petitions tab
	 * <li><font color="green"><b>Verify that record about the widget is on the
	 * top of the table (Petitions) and status is PUBLISHED and visibility is
	 * PUBLIC</b></font>
	 ...
	 * <li><font color="green"><b>Verify that form is visible to potential
	 * supporter (Verify all form elements are displayed)</b></font>
	...
	public void testCreateAndPublishPetition() {
		...
		// verify that new widget is present in table in All Activities tab
		// (Published state)
		...
		// verify that new widget present in table in Petitions tab (Published
		// state)
		activitiesPage.openPetitionsPage().verifyWidgetIsPresentInTableForms(widgetName, widgetDescription, "PUBLISHED",
				"PUBLIC");
		// open widget link in new tab and ensure it visible for CM and
		// supporter
	 ...
	 * <li><font color="green"><b>Verify that new signature is displayed on the
	 * form</b></font>
	 * <li>Close window with form
	 * <li><font color="green"><b>Verify that table with supporters contains
	 * record about new supporter</b></font>
	...
	@Test(enabled = true, priority = 2, groups = {
			"createAndPublishPetition" }, retryAnalyzer = RetryAnalyzer.class, dependsOnMethods = {
					"testCreateAndPublishPetition" })
	 ...
	 * <li>Open in separated window link to form
	 * <li>Delete cookies and refresh page
	 * <li>Fill all fields, uncheck the " Display My Signature" checkbox and
	 * click "Sign" button
	 * <li><font color="green"><b>Verify that new signature is displayed on the
	 * form</b></font>
	 * <li><font color="green"><b>Verify that person name is
	 * Anonymous</b></font>
	 * <li>Close window with form
	 * <li><font color="green"><b>Verify that table with supporters contains
	 * record about new supporter</b></font>
	 ...
	 */
	  ...
	  @Test(enabled = true, priority = 3, groups = { "createAndPublishPetition"
	                }, retryAnalyzer = RetryAnalyzer.class, dependsOnMethods =
	                {"testCreateAndPublishPetition"}) public void
	                testAnonymousSignPetition() { signPetition(false, true); }
	 ...
	 * <li>Open in separated window link to form
	 * <li>Delete cookies and refresh page
	 * <li>Fill all fields, uncheck the " Display My Comment" checkbox and click
	 * "Sign" button
	 * <li><font color="green"><b>Verify that new signature is displayed on the
	 * form</b></font>
	 * <li><font color="green"><b>Verify that comment is not displayed on the
	 * form</b></font>
	 * <li>Close window with form
	 * <li><font color="green"><b>Verify that table with supporters contains
	 * record about new supporter</b></font>
	...
	private void signPetition(boolean displaySignature, boolean displayComment) {
		...
		SupportersPage supportersPage = addPetitionPage.openPetitionWidget()
		...
		supportersPage.openSupporterDetailsPage().verifySupporterStatus("Subscribed");
	}

	private void doLoginAndOpenPetitionsPage() {
		addPetitionPage = new LoginPage().doSuccessLogin().openActivitiesPage().openPetitionsPage()
				.openAddPetitionPage();
	}
