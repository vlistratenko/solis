...
public class InviteNewCMTest extends SeleneseTestCase {
	 ...
	 *  
	 */
	@Test(enabled = true, groups = {"inviteCM", "resendInvite"}, retryAnalyzer=RetryAnalyzer.class)
	 ...
	 *  
	 */
	@Test(enabled = true, groups = {"resendInvite"}, retryAnalyzer=RetryAnalyzer.class, dependsOnMethods = {"inviteNewCM"})
	 ...
	 *  
	 */
	@Test(enabled = true, groups = {"inviteCM", "resendInvite"}, retryAnalyzer=RetryAnalyzer.class, dependsOnMethods = {"inviteNewCM","resendInvitation"})
